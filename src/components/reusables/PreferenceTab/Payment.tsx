import { createListCollection, Field, NumberInput, Select, Text, Textarea, VStack, InputGroup, Switch, HStack, Button } from "@chakra-ui/react"
  ...
  return (
    <form action="" style={{width: "100%"}}>
      ...
      >
        ...
        <Button w="full" variant="solid" type="submit" size="sm" borderRadius="4xl" mt={4}> Save Preferences</Button>
      </VStack>
    </form>
  )
}
